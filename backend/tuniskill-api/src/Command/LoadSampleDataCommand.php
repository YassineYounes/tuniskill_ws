...
#[AsCommand(
    ...
    description: 'Load sample data for the TuniSkill platform',
)]
class LoadSampleDataCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->title('Loading Sample Data for TuniSkill');

        // Create Categories
        $this->createCategories($io);
        
        // Create Courses
        $this->createCourses($io);
    ...
    private function createCategories(SymfonyStyle $io): void
    {
        ...
        foreach ($categoriesData as $categoryData) {
            ...
            $io->writeln('Created category: ' . $categoryData['name']);
        }
    }

    private function createCourses(SymfonyStyle $io): void
    {
        ...
        foreach ($coursesData as $courseData) {
            ...
            $io->writeln('Created course: ' . $courseData['title']);
        }
    }
}
